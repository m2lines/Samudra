#!/bin/bash
#SBATCH -p pi_abodner
#SBATCH --job-name=2026-05-29-eval:Samudra_LLC:long_curriculum_strides=3_ckpt-38-7days
#SBATCH -N 1
#SBATCH --mem=100GB
#SBATCH --ntasks=1
...
CKPT_PATH="${CKPT_PATH:-/home/codycruz/Ocean_Emulator/.LOCAL/2026-05-28:samudra_llc:long_curriculum_strides=3_CONT_restart_3-14675672/saved_nets/ckpt_38.pt}"
