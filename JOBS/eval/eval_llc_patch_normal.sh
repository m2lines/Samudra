...
#SBATCH --job-name=2026-05-21-eval:Samudra_LLC:mae+mse+gradient-loss_steps=(3,4)_ckpt5
...
CKPT_PATH="${CKPT_PATH:-/home/codycruz/Ocean_Emulator/.LOCAL/2026-05-20:samudra_llc:mae+mse+gradient-loss_steps=(3,4)_test/saved_nets/ckpt_5.pt}"
...
NUM_MODEL_STEPS_FORWARD="${NUM_MODEL_STEPS_FORWARD:-3}"
