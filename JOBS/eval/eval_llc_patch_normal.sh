...
#SBATCH --job-name=2026-07-06-eval:Samudra_LLC:rb-Agulhas-strides=1-pred_field-ckpt-20
...
CKPT_PATH="${CKPT_PATH:-/orcd/data/abodner/002/cody/overflow/wandb_overflow/rb/complete/2026-07-04:samudra_llc:rb-Agulhas-strides=1-pred_field-3-17153919/saved_nets/ckpt_20.pt}"
