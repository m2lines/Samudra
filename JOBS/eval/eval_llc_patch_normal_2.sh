...
#SBATCH --job-name=2026-05-27-eval:Samudra_LLC:mse+mae,grad_z,h_temporal-subset-1_ckpt-24
...
CKPT_PATH="${CKPT_PATH:-/home/codycruz/Ocean_Emulator/.LOCAL/2026-05-26:samudra_llc:mse+mae,grad_z,h_temporal-subset-1-14560620/saved_nets/ckpt_24.pt}"
