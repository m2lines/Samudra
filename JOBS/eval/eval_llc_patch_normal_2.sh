...
#SBATCH --job-name=2026-06-22-eval:Samudra_LLC:long_curriculum_strides=1_ckpt-24
...
CKPT_PATH="${CKPT_PATH:-/home/codycruz/Ocean_Emulator/.LOCAL/2026-06-18:samudra_llc:long_curriculum_strides=1_CONT_restart-6-16056916/saved_nets/ckpt_24.pt}"
