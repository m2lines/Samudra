...
#SBATCH --job-name=2026-07-01-eval:Samudra_LLC:rb-Agulhas-strides=3-pred_resid-ckpt-6
...
CKPT_PATH="${CKPT_PATH:-/home/codycruz/Ocean_Emulator/.LOCAL/2026-06-30:samudra_llc:rb-Agulhas-strides=3-pred_resid-16875996/saved_nets/ckpt.pt}"
