...
#SBATCH --job-name=2026-06-22-eval:Samudra_LLC:B,ckpt:72
...
CKPT_PATH="${CKPT_PATH:-/home/codycruz/Ocean_Emulator/.LOCAL/2026-06-20:samudra_llc:B-15-16155822/saved_nets/ckpt_72.pt}"
