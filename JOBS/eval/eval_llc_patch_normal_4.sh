...
#SBATCH --job-name=2026-05-18-eval:Samudra_LLC:strides=3,ckpt_22
...
CKPT_PATH="${CKPT_PATH:-/home/codycruz/Ocean_Emulator/.LOCAL/2026-05-13:samudra_llc:long_curriculum_strides=3/saved_nets/ckpt_22.pt}"
