...
#SBATCH --job-name=2026-08-09-eval:Samudra_LLC:4-tile-blended-rollout
...
CKPT_PATH="${CKPT_PATH:-/orcd/data/abodner/002/cody/overflow/wandb_overflow/rb/2026-08-06:samudra_rb_llc:4-tile-base-experiment-19805916/saved_nets/ckpt.pt}"
