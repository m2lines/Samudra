#!/bin/bash
#SBATCH -p pi_abodner
#SBATCH --job-name=2026-04-23-eval:Samudra_LLC:config_tests_experiment_1
#SBATCH -N 1
#SBATCH --mem=200GB
#SBATCH --ntasks=1
...
CKPT_PATH="${CKPT_PATH:-/home/codycruz/Ocean_Emulator/.LOCAL/2026-04-21-Samudra_LLC:config_tests_experiment_1/saved_nets/ckpt.pt}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-2026-04-23-eval:Samudra_LLC:config_tests_experiment_1}"
BASE_OUTPUT_DIR="${BASE_OUTPUT_DIR:-/orcd/data/abodner/002/cody/inference_patch/config_tests_4-23-26}"
