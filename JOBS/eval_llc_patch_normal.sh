...
#SBATCH --job-name=2026-05-2-eval:Samudra_LLC:replication_data-stride-72
...
CKPT_PATH="${CKPT_PATH:-/home/codycruz/Ocean_Emulator/.LOCAL/2026-04-30-Samudra_LLC:replication_data-stride=72/saved_nets/ckpt_4.pt}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-2026-05-2-eval:Samudra_LLC:replication_data-stride-72}"
BASE_OUTPUT_DIR="${BASE_OUTPUT_DIR:-/orcd/data/abodner/002/cody/inference_patch}"

INFER_START="${INFER_START:-2012-10-01}"
INFER_END="${INFER_END:-2012-10-22}"
INFERENCE_STRIDE="${INFERENCE_STRIDE:-72}"
