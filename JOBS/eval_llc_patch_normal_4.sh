...
#SBATCH --job-name=2026-04-29-eval:Samudra_LLC:res_experiment_0_epoch10
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-2026-04-29-eval:Samudra_LLC:res_experiment_0_epoch10}"
