#!/bin/bash
#SBATCH -p pi_abodner
#SBATCH --job-name=2026-05-25:samudra_llc:long_curriculum_strides=3_CONT_restart_2
#SBATCH -N 1
#SBATCH --mem=300GB
#SBATCH --ntasks=1
...
RESUME_CKPT_PATH="${RESUME_CKPT_PATH:-/orcd/data/abodner/002/cody/overflow/wandb_overflow/2026-05-21:samudra_llc:long_curriculum_strides=3_CONT-14194631/saved_nets/ckpt_24.pt}" #/home/codycruz/Ocean_Emulator/.LOCAL/2026-04-24-Samudra_LLC:config_tests_experiment_6_multi_epochs/saved_nets/ckpt_6.pt
