#!/bin/bash
#SBATCH -p pi_abodner
#SBATCH --job-name=2026-05-21:samudra_llc:long_curriculum_strides=1_CONT
#SBATCH -N 1
#SBATCH --mem=125GB
#SBATCH --ntasks=1
...
RESUME_CKPT_PATH="${RESUME_CKPT_PATH:-/home/codycruz/Ocean_Emulator/.LOCAL/2026-05-13:samudra_llc:long_curriculum_strides=1/saved_nets/ckpt_8.pt}" #/home/codycruz/Ocean_Emulator/.LOCAL/2026-04-24-Samudra_LLC:config_tests_experiment_6_multi_epochs/saved_nets/ckpt_6.pt
