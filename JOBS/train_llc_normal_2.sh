...
#SBATCH --job-name=2026-06-20:samudra_llc:B-15
#SBATCH -N 1
#SBATCH --mem=254GB
#SBATCH --ntasks=1
...
RESUME_CKPT_PATH="${RESUME_CKPT_PATH:-/home/codycruz/Ocean_Emulator/.LOCAL/2026-06-18:samudra_llc:B-14-16056861/saved_nets/ckpt_emergency.pt}" #/home/codycruz/Ocean_Emulator/.LOCAL/2026-04-24-Samudra_LLC:config_tests_experiment_6_multi_epochs/saved_nets/ckpt_6.pt
