...
#SBATCH --job-name=2026-08-31:samudra_rb_llc:4-752-tile-3
#SBATCH -x node4100
#SBATCH -N 1
#SBATCH --mem=254GB
#SBATCH --ntasks=1
...
RESUME_CKPT_PATH="${RESUME_CKPT_PATH:-/orcd/data/abodner/002/cody/overflow/wandb_overflow/rb/2026-08-29:samudra_rb_llc:4-752-tile-2-21569256/saved_nets/ckpt_emergency.pt}"
...
REPLAY_STEPS_PER_EPOCH="${REPLAY_STEPS_PER_EPOCH:-17520}" #8760
