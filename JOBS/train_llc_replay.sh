...
#SBATCH --job-name=2026-07-13:samudra_llc:rb-Agulhas-shardtensor_control-MSE
...
# DATA
LLC_FACE="${LLC_FACE:-1}"
LLC_I_START="${LLC_I_START:-1072}"
LLC_I_END="${LLC_I_END:-2160}"
LLC_J_START="${LLC_J_START:-1072}"
LLC_J_END="${LLC_J_END:-2160}"
DATA_LOCATION_OVERRIDE="${DATA_LOCATION_OVERRIDE:-/orcd/data/abodner/002/cody/LLC_patch/LLC4320_face1_i1072-2160_j1072-2160_trainval_ready_20110913_20121014_t1.zarr}"
