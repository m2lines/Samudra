...
#SBATCH --job-name=2026-07-16:samudra_llc:rb-Agulhas-strides=1-pred_field-eager-3-LOSS-RESTART
...
RESUME_CKPT_PATH="${RESUME_CKPT_PATH:-/orcd/data/abodner/002/cody/overflow/wandb_overflow/rb/2026-07-09:samudra_llc:rb-Agulhas-strides=1-pred_field-reg-2-17560391/saved_nets/ckpt_20.pt}"
