...
#SBATCH --job-name=2026-08-31:samudra_rb_llc:wider_model-[384,576,768,1024]-4
#SBATCH -x node4100
#SBATCH -N 1
#SBATCH --mem=254GB
#SBATCH --ntasks=1
...
RESUME_CKPT_PATH="${RESUME_CKPT_PATH:-/orcd/data/abodner/002/cody/overflow/wandb_overflow/rb/2026-08-29:samudra_rb_llc:wider_model-[384,576,768,1024]-3-21569491/saved_nets/ckpt_emergency.pt}"
