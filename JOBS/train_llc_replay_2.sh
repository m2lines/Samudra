...
#SBATCH --job-name=2026-07-09:samudra_llc:rb-Agulhas-strides=1-pred_field-eager-2
...
RESUME_CKPT_PATH="${RESUME_CKPT_PATH:-/orcd/data/abodner/002/cody/overflow/wandb_overflow/rb/2026-07-06:samudra_llc:rb-Agulhas-strides=1-pred_field-eager-17317961/saved_nets/ckpt_emergency.pt}"
