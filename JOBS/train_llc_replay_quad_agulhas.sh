...
#SBATCH --job-name=2026-07-09:samudra_llc:rb-1-quad-Agulhas_eager-2
...
RESUME_CKPT_PATH="${RESUME_CKPT_PATH:-/orcd/data/abodner/002/cody/overflow/wandb_overflow/rb/2026-07-06:samudra_llc:rb-1-quad-Agulhas_eager-17355939/saved_nets/ckpt_emergency.pt}"
