...
#SBATCH --job-name=2026-07-04:samudra_llc:rb-1-quad-Agulhas_reduced_ch-width-2
...
RESUME_CKPT_PATH="${RESUME_CKPT_PATH:-/orcd/data/abodner/002/cody/overflow/wandb_overflow/rb/2026-07-04:samudra_llc:rb-1-quad-Agulhas_reduced_ch-width-1-17162687/saved_nets/ckpt_emergency.pt}"
