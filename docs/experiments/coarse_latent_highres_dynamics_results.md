...
| `2026-07-24-coarse-moment-attn-s1-proxy-prem-s0` | S1 | pending commit | Same cross-resolution proxy on the `cpu_prem` preemptible partition | Preparing | Requeue on batch-level `USR1`; checkpoint every epoch and resume automatically |
