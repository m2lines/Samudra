...
# Joint interior diffusion and latent evolution on beta
...
Do not mistake its completed OM4 source pretraining for completion of the
observation-transfer comparison or final baseline selection.
