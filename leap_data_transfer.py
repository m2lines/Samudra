...
# CM4 data
ds = xr.open_dataset(fs.get_mapper('gs://leap-persistent/jbusecke/ocean-emulators/OM4_5daily_v0.2.1.zarr'), engine='zarr', chunks={})
print(ds)

with ProgressBar():
    ds.to_zarr('/pscratch/sd/s/suryad/data/3D_data_OM4_v0.2.1.zarr',
