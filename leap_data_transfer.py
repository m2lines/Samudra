...
# Prediction
mapper = fs.get_mapper("gs://leap-persistent/sd5313/convnextpredepoch50.zarr")
ds = xr.open_zarr(
    "/scratch/sd5313/M2Lines/emulator/Ocean_Emulator/Preds/ConvNext UNet Train3DSurfaceEval3DEpoch50_Train_global_3D_Test_global_3D_all_N_train_4000_Lateral_Data_025_no_smooth/Pred_lateral_Fast_Data_025_global_3D_all_N_samples_4000_rand_seed_1.zarr"
)
