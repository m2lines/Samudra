...
# ./.python-greene submitit_hydra.py $comp exp=save_3D_data_global name="$(date +%F)-save_3D_data_surface_test" region=global_3D depth_mode=surface

# ./.python-greene submitit_hydra.py $comp exp=save_3D_data_global name="$(date +%F)-save_3D_data" region=global_3D depth_mode=all
