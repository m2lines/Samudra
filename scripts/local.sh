...
./.python-greene submitit_hydra.py $comp exp=save_data_global name="$(date +%F)-save_data_global21"

# ./.python-greene submitit_hydra.py $comp exp=save_data_recunet name="$(date +%F)-save_data_gulfext_hist1_interval2"
