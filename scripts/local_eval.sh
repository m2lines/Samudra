...
# ./.python-greene submitit_hydra.py $comp exp=eval_swin_global network="Swin" name="$(date +%F)-eval_swin_g1_g1" train_region=global_1 region=global_1 swin.embed_dim=24 ckpt_path=''
