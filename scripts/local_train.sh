...
# anom 1975
# ./.python-perlmutter submitit_hydra.py compute=local testing=true exp=train_unet_global_3D_all_hfds_anom_1975 name="$(date +%F)-convnextunet_v021_hist1_hfds_anom_1975" region=global_3D batch_size=3 scheduler=True rand_seed=15 unet.ch_width=[42,100,150,200,300] hist=1 epochs=70

# anom 1975 + nofast - T,S,SSH
./.python-perlmutter submitit_hydra.py compute=local testing=true exp=train_unet_global_3D_all_hfds_anom_1975 name="$(date +%F)-convnextunet_v021_hist1_hfds_anom_1975_nofast" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[42,100,150,200,300] hist=1 epochs=70 exp_num_in=3D_noFast_all exp_num_out=3D_noFast_all resume_ckpt_path=/pscratch/sd/s/suryad/Ocean_Emulator/train_3D/2024-10-14-convnextunet_v021_hist1_hfds_anom_1975_nofast_SimVPinspired/aaa/saved_nets/convnextunet_epoch_60_steps_4_global_3D_all_N_train_2850_Lateral_Data_025_no_smooth.pt
