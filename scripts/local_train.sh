...
# All
./.python-perlmutter submitit_hydra.py $comp testing=true wandb.mode=online exp=train_unet_global_3D_all name="$(date +%F)-local_train_convnextunet_global_3D_all_hist0" region=global_3D batch_size=4 scheduler=True rand_seed=10 unet.ch_width=[80,100,150,300,400] hist=0
