...
# 3. Swin Global
./.python-greene submitit_hydra.py $comp exp=train_swin_global name="$(date +%F)-local_train_swin_global_1" region=global_1 batch_size=16 scheduler=True rand_seed=10
