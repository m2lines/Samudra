...
# Surface only
# v0.0
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_4hrs wandb.mode=online exp=train_unet_global_2Dv0.0 name="$(date +%F)-train_convnextunet_global_2Dv0.0_100epochs" epochs=100 region=global_3D batch_size=16 scheduler=True rand_seed=10
...
# 5 levels
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_5 name="$(date +%F)-train_convnextunet_global_3D_5levels" region=global_3D batch_size=4 scheduler=True rand_seed=10 unet.ch_width=[80,100,150,300,400] hist=1

# 5 No fast output
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_5 name="$(date +%F)-train_convnextunet_global_3D_5levels_NoFastOuts" region=global_3D batch_size=4 scheduler=True rand_seed=10 unet.ch_width=[80,100,150,300,400] hist=1 exp_num_out=3D_noFast_5

# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_debug testing=true exp=train_unet_global_3D_all name="$(date +%F)-convnextunet_v021_testingseed2" region=global_3D batch_size=4 scheduler=True rand_seed=10 unet.ch_width=[157,200,250,300,400] hist=1 N_samples=128

# All history=1 cos
# ./.python-greene submitit_hydra.py compute/greene=1x4 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_all name="$(date +%F)-convnextunet_v021_hist1_sqrtcosloss_resume" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 loss=mse_cos_weighted resume_ckpt_path=/scratch/sd5313/M2Lines/emulator/Ocean_Emulator/train_3D/2024-09-05-convnextunet_v021_hist1_sqrtcosloss/aaa/saved_nets/convnextunet_epoch_45_steps_4_global_3D_all_N_train_4000_Lateral_Data_025_no_smooth.pt
...
# ./.python-greene submitit_hydra.py compute/greene=1x4 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_all_hfds_anom name="$(date +%F)-convnextunet_v021_hist1_hfds_anom_nofast" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 exp_num_in=3D_noFast_all exp_num_out=3D_noFast_all

# All history=1 hfds anom + no fast inp/out 1975
...
# All history=1 hfds anom 1975
# ./.python-greene submitit_hydra.py compute/greene=1x4 compute/greene/node=a100_30hrs wandb.mode=online exp=train_unet_global_3D_all_hfds_anom_1975 name="$(date +%F)-convnextunet_v021_hist1_hfds_anom_1975" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70

# All history=1 hfds anom 1975 + diff loss
# ./.python-greene submitit_hydra.py compute/greene=1x4 compute/greene/node=a100_30hrs wandb.mode=online exp=train_unet_global_3D_all_hfds_anom_1975 name="$(date +%F)-convnextunet_v021_hist1_hfds_anom_1975_diffloss" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 loss=mse_diff_weighted

# All history=1 hfds anom + diff loss
# ./.python-greene submitit_hydra.py compute/greene=1x4 compute/greene/node=a100_30hrs wandb.mode=online exp=train_unet_global_3D_all_hfds_anom name="$(date +%F)-convnextunet_v021_hist1_hfds_anom_diffloss" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 loss=mse_diff_weighted
...
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_all name="$(date +%F)-convnextunet_v021_hist1_onlyfastout" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 exp_num_out=3D_onlyFast_all


# All history=0
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_all name="$(date +%F)-convnextunet_hist0_35epochs" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[80,100,150,300,400] hist=0
