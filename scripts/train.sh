...
# Surface only
# v0.0
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_4hrs wandb.mode=online exp=train_unet_global_2Dv0.0 name="$(date +%F)-train_convnextunet_global_2Dv0.0_100epochs" epochs=100 region=global_3D batch_size=16 scheduler=True rand_seed=10 --qos=regular

# v0.2.1
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_3hrs wandb.mode=online exp=train_unet_global_2D name="$(date +%F)-train_convnextunet_global_2D" region=global_3D batch_size=16 scheduler=True rand_seed=10

# 5 levels
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_5 name="$(date +%F)-train_convnextunet_global_3D_5levels" region=global_3D batch_size=4 scheduler=True rand_seed=10 unet.ch_width=[80,100,150,300,400] hist=1 --qos=regular

# 5 No fast output
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_5 name="$(date +%F)-train_convnextunet_global_3D_5levels_NoFastOuts" region=global_3D batch_size=4 scheduler=True rand_seed=10 unet.ch_width=[80,100,150,300,400] hist=1 exp_num_out=3D_noFast_5 --qos=regular

# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_debug testing=true exp=train_unet_global_3D_all name="$(date +%F)-convnextunet_v021_testingseed2" region=global_3D batch_size=4 scheduler=True rand_seed=10 unet.ch_width=[157,200,250,300,400] hist=1 N_samples=128 --qos=debug

# All history=0 hfds anom
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_30hrs wandb.mode=online exp=train_unet_global_3D_all_hfds_anom_1975 name="$(date +%F)-convnextunet_v021_hist0_hfds_anom_1975" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[81,200,250,300,400] hist=0 epochs=70 --qos=regular

# All history=1
# ./.python-greene submitit_hydra.py compute/greene=4x2 compute/greene/node=a100_30hrs wandb.mode=online exp=train_unet_global_3D_all name="$(date +%F)-convnextunet_v021_hist1_140epochs" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=140 --qos=regular

# All history=1 hfds anom
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_debug wandb.mode=online exp=train_unet_global_3D_all_hfds_anom name="$(date +%F)-convnextunet_v021_hist1_hfds_anom_restart" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 resume_ckpt_path=/scratch/sd5313/M2Lines/emulator/Ocean_Emulator/train_3D/2024-09-04-convnextunet_v021_hist1_hfds_anom/aaa/saved_nets/convnextunet_epoch_55_steps_4_global_3D_all_N_train_4000_Lateral_Data_025_no_smooth.pt --qos=debug

# All history=1 1975 + no fast inp/out 
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_all_1975 name="$(date +%F)-convnextunet_v021_hist1_1975" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 exp_num_in=3D_noFast_all exp_num_out=3D_noFast_all --qos=regular

# All history=1 1975 cuminteg + no fast inp/out 
./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_14hrs wandb.mode=online exp=train_unet_global_3D_all_hfds_cuminteg_1975 name="$(date +%F)-convnextunet_v021_hist1_1975_onlyseasonalizedcuminteg" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 exp_num_in=3D_noFast_all exp_num_out=3D_noFast_all --qos=regular

# All history=1 1975 cuminteg
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_all_hfds_anomcuminteg_1975 name="$(date +%F)-convnextunet_v021_hist1_1975_cuminteg_all" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 --qos=regular

# All history=1 hfds anom + no fast inp/out 
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_all_hfds_anom_1975 name="$(date +%F)-convnextunet_v021_hist1_hfds_anom_1975_nofast_iterativesteptraining" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=100 exp_num_in=3D_noFast_all exp_num_out=3D_noFast_all --qos=regular

# All history=1 hfds anom + only Temp
# ./.python-greene submitit_hydra.py compute/greene=4x2 wandb.mode=online compute/greene/node=a100_1day exp=train_unet_global_3D_all_hfds_anom_1975 name="$(date +%F)-convnextunet_v021_hist1_hfds_anom_1975_onlyTemp_deltaTmix_Full" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 exp_num_in=3D_onlyTemp_all exp_num_out=3D_onlyTemp_all --qos=regular

# Finetune mix delta T
# ./.python-greene submitit_hydra.py compute/greene=2x2 wandb.mode=online compute/greene/node=a100_1day exp=train_unet_global_3D_all_hfds_anom_1975_finetune name="$(date +%F)-convnextunet_v021_hist1_hfds_anom_1975_onlyTemp_deltaTmix_Full_Finetune" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 exp_num_in=3D_onlyTemp_all exp_num_out=3D_onlyTemp_all resume_ckpt_path=/scratch/sd5313/M2Lines/emulator/Ocean_Emulator/train_3D/2024-09-29-convnextunet_v021_hist1_hfds_anom_1975_onlyTemp_deltaTmix_Full/convnextunet_epoch_20_beststeps_4_global_3D_all_N_train_2850_Lateral_Data_025_no_smooth.pt --qos=regular

# Hist 1 anom 1982_90 Reordered
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_30hrs wandb.mode=online exp=train_unet_global_3D_all_hfds_anom_1980_90reordered name="$(date +%F)-convnextunet_v021_hist1_hfds_anom_82_90" region=global_3D batch_size=4 scheduler=True rand_seed=10 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 --qos=regular
...
# All history=1 loss
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_all name="$(date +%F)-convnextunet_v021_hist1_sqrtcosloss" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 loss=mse_cos_weighted --qos=regular

# All history=1 Fast Smoothed 30
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_all_smoothed30 name="$(date +%F)-convnextunet_v021_hist1_fastsmoothed10_110G" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=35 --qos=regular

# All history=1 Fast Smoothed 30 TEST
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_debug wandb.mode=online testing=true exp=train_unet_global_3D_all_smoothed30 name="$(date +%F)-convnextunet_v021_hist1_fastsmoothed30_explicit_110g" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 --qos=debug

# All history=1 No fast input/output
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_all name="$(date +%F)-convnextunet_v021_hist1_nofastinout_epochs70" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 exp_num_in=3D_noFast_all exp_num_extra=3D_noFast_all exp_num_out=3D_noFast_all epochs=70 --qos=regular

# All history=1 Only fast output
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_all name="$(date +%F)-convnextunet_v021_hist1_onlyfastout" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 exp_num_out=3D_onlyFast_all --qos=regular


# All history=0
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_unet_global_3D_all name="$(date +%F)-convnextunet_hist0_35epochs" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[80,100,150,300,400] hist=0 --qos=regular


### Swin

# All
# ./.python-greene submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_1day wandb.mode=online exp=train_swin_global_3D_all name="$(date +%F)-train_swin_global_3D_all_out2_35epochs" region=global_3D batch_size=4 scheduler=True rand_seed=10 exp/modules/blocks@swin.up_sampling_block=transposed_conv_upsample swin.embed_dim=180 hist=1
