...
./.python-perlmutter submitit_hydra.py compute/greene=8x2 compute/greene/node=a100_30hrs wandb.mode=online exp=train_unet_global_3D_all_CM4 name="$(date +%F)-convnextunet_CM4_hist1_140epochs" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=140 exp_num_in=3D_noFast_all exp_num_out=3D_noFast_all --qos=regular

# All history=1 CM4 All vars - approx 21 hrs for 16 GPUs
# ./.python-perlmutter submitit_hydra.py compute/greene=8x2 compute/greene/node=a100_30hrs wandb.mode=online exp=train_unet_global_3D_all_CM4 name="$(date +%F)-convnextunet_CM4_hist1_allvars" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 epochs=70 --qos=regular