...
./.python-perlmutter submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_12hrs wandb.mode=online exp=train_unet_global_3D_all name="$(date +%F)-train_convnextunet_global_3D_hist1_130M_out2_wtinit_10epochs" region=global_3D batch_size=4 scheduler=True rand_seed=15 unet.ch_width=[157,200,250,300,400] hist=1 --qos=regular
