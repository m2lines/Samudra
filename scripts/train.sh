...
./.python-greene submitit_hydra.py compute/greene=1x2 compute/greene/node=rtx8000_3hrs exp=train_swin_global wandb.mode=online name="$(date +%F)-train_swin_global_1" region=global_1 batch_size=16 swin.embed_dim=24 scheduler=True exp/unet/modules/blocks@swin.up_sampling_block=bilinear_upsample
