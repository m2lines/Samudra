...
# All
./.python-perlmutter submitit_hydra.py compute/greene=2x2 compute/greene/node=a100_4hrs wandb.mode=online exp=train_unet_global_3D_all name="$(date +%F)-train_convnextunet_global_3D_hist0_4hrs" region=global_3D batch_size=4 scheduler=True rand_seed=10 unet.ch_width=[80,100,150,300,400] hist=0 --qos=preempt
