...
from utils.data_utils import get_wet_mask, get_train_test_ranges, gen_data_025_lateral,\
                             gen_data_in, gen_data_out, data_CNN_Lateral, data_CNN_steps_Lateral,\
                             get_data_tensors
...
def main(args):
    ...
    inputs, extra_in, _ = gen_data_025_lateral(inputs,extra_in,outputs,args.lag,REGIONS[args.region]["lat"], REGIONS[args.region]["lon"],args.Nb)
