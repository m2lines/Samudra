...
if __name__ == "__main__":
    train_data = torch.load(
        "/scratch/sd5313/M2Lines/emulator/Ocean_Emulator/.LOCAL/save_data/2024-03-31-save_data_gulfext2/data/train_data_cnn_steps_8_Gulf_Stream_Ext2_Test_in_um_vm_Tm_ext_tau_u_tau_v_t_ref__outum_vm_Tm_N_train_4000_Lateral_Data_025_no_smooth.pt",
        map_location="cpu",
    )
    recdata = RecUnetDataset(
        "/scratch/sd5313/M2Lines/emulator/Ocean_Emulator/.LOCAL/save_data_tensor/2024-03-31-save_data_tensor_recunet_with_wet/data/train_data_steps_0_Gulf_Stream_Ext2_Test_in_um_vm_Tm_ext_tau_u_tau_v_t_ref__outum_vm_Tm_N_train_4000_Lateral_Data_025_no_smooth.pt",
        8,
        2,
        1,
        3,
        4,
        "/scratch/sd5313/M2Lines/emulator/Ocean_Emulator/.LOCAL/save_data_tensor/2024-03-31-save_data_tensor_recunet_with_wet/data/wet_steps_0_Gulf_Stream_Ext2_Test_in_um_vm_Tm_ext_tau_u_tau_v_t_ref__outum_vm_Tm_N_train_4000_Lateral_Data_025_no_smooth.pt",
    )
