...
@contextmanager
def profiler_context(profiling_enabled, is_main_process, profiling_start_epoch, profiling_end_epoch, epoch):
    profiler_active = False
    if profiling_enabled and profiling_start_epoch <= epoch <= profiling_end_epoch:
        if is_main_process and profiling_start_epoch == epoch:
    ...
    try:
        ...
        if profiling_enabled and is_main_process and epoch == profiling_end_epoch:
